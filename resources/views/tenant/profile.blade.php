                        ...
                        <div class="col-sm-12">
                            <div class="element-wrapper">
                                <div class="element-box">
                                    <form id="formValidate" action="{{url('editTenantDetails')}}" method="post">
                                        @csrf
                                        ...
                                        <div class="form-group"><label for="">Id No</label><input
                                                class="form-control" data-error="Your IdNo is invalid"
                                                placeholder="{{$tenant->idno}}" value="{{$tenant->idno}}" name="idno" required="required" type="text">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>
                                        <div class="form-group"><label for="">Phone No</label><input
                                                class="form-control" data-error="Your Phone No is invalid"
                                                placeholder="{{$tenant->phone}}" value="{{$tenant->phone }}" name="phone" required="required" type="text">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>
                                        <div class="row">
                                            <div class="col-sm-6">

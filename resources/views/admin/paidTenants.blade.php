...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><span>Paid Tenants</span></li>
</ul>
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper"><h6 class="element-header">REPORTS</h6>
            <div class="element-box"><h5 class="form-header">Paid Tenants</h5>
                <div class="table-responsive">
                    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                        ...
                        <tr>
                            <td>{{$paidTenant->tenant->name}}</td>
                            <td>{{$paidTenant->property}}</td>
                            <td>{{$paidTenant->house}}</td>
                            <td>{{$paidTenant->houseType}}</td>
                            <td>{{$paidTenant->amount}}</td>
                            <b><td>{{$paidTenant->balance}}</td></b>
                            <td class="text-center">
                                <div class="status-pill green" data-title="complete"
                                     data-toggle="tooltip"></div><i>Paid</i>
                            </td>
                        </tr>
                        @endforeach

...
<title>Edit House Details</title>
    <div class="content-w">
            <ul class="breadcrumb">
                ...
                <li class="breadcrumb-item"><span>Edit House Details</span></li>
            </ul>
                        ...
                        <div class="col-sm-12">
                            <div class="element-wrapper">
                                <div class="element-box">
                                    <form action="{{url('editHouse',$edit->id)}}" method="post">
                                        @csrf
                                        <div class="element-info">
                                            <div class="element-info-with-icon">
                                                ...
                                                <div class="element-info-text"><h5 class="element-inner-header">Edit House Details</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group"><label for="">House Number</label><input
                                        ...
                                        <div class="form-group"><label for="">House Type</label><input
                                                class="form-control" data-error="Your Name is invalid"
                                                placeholder="{{$edit->type}}" name="type" required="required" type="text" value="{{$edit->type}}">
                                            <div class="help-block form-text with-errors form-control-feedback"></div>
                                        </div>

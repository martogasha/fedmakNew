                    ...
                    <div class="row">
                        <div class="col-md-8">
                            <div class="order-box">
                                ...
                                <hr>
                                <div class="order-details-box">
                                    <div class="order-main-info"><span><b>Number of Houses </b></span><strong>10 <a href="{{url('propertyUnits',$property->id)}}"><button class="btn btn-outline-secondary">View</button></a></strong></div>

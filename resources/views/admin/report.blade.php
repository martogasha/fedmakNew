...
<ul class="breadcrumb">
    ...
    <li class="breadcrumb-item"><span>Report</span></li>
</ul>
<div class="content-i">
    <div class="content-box">
        <div class="element-wrapper"><h6 class="element-header">REPORTS</h6>
            <div class="element-box"><h5 class="form-header">Report</h5>
                    ...
                    <table id="dataTable1" width="100%" class="table table-striped table-lightfont">
                        ...
                        @foreach($reports as $report)
                            <tr>
                                ...
                                <td>{{$report->house}}</td>
                                <td>{{$report->houseType}}</td>
                                <td>{{$report->amount}}/=</td>
                                @if($report->status==1)
                                <td class="text-center">
                                    <div class="status-pill red" data-title="complete"
                                         data-toggle="tooltip"></div><i>Bill</i>
                                </td>
                                @else
                                    <td class="text-center">
